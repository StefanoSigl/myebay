...
@WebServlet("/annuncio/PrepareSearchAnnuncioPersonaliServlet")
public class PrepareSearchAnnuncioPersonaliServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("searchPersonali.jsp").forward(request, response);
	}
